      ...
      <div className="grid md:grid-cols-4 gap-12 mb-20">
        <div className="col-span-2">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/westonopticians/?hl=en" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-zinc-300 flex items-center justify-center hover:bg-brand-purple hover:border-brand-purple hover:text-white transition-all">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="https://www.facebook.com/westonopticians" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-zinc-300 flex items-center justify-center hover:bg-brand-purple hover:border-brand-purple hover:text-white transition-all">
